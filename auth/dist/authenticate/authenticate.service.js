...
const bcrypt = __importStar(require("../../node_modules/bcryptjs/umd/index.js"));
...
let AuthenticateService = class AuthenticateService {
    ...
    async authenticate(authenticateDto) {
        const user = await this.em.findOne(user_entity_1.User, { username: authenticateDto.username });
        if (!user) {
...
exports.AuthenticateService = AuthenticateService = __decorate([
    ...
    __metadata("design:paramtypes", [postgresql_1.EntityManager, jwt_1.JwtService])
], AuthenticateService);
